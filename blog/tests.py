...
class TestMode(TestCase):
    ...
    def test_tag(self):
        ...
        self.assertEqual(post_000.tags.count(), 2) #여러개의 tag를 가질 수 있다.
    ...
    def test_comment(self):
        ...
        self.assertEqual(post_000.comment_set.count(), 2) #post_000 에서 comment들을 불러오기
...
class TestView(TestCase):
    ...
    def test_tag_page(self):
        ...
        response = self.client.get(tag_000.get_absolute_url()) #client.get()은 브라우저에서 주소로 가는 역할
        self.assertEqual(response.status_code, 200)
    ...
    def test_search(self):
        ...
        response = self.client.get('/blog/search/I am/')
        self.assertEqual(response.status_code, 200)
        soup = BeautifulSoup(response.content, 'html.parser')
